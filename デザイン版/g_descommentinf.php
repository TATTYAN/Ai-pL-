...
if($len == 0){
  ...
  mysql_db_query( "b31_c467", "insert DesignComment_tbl(userid,user,contents,datetime)
  values($userid,'$name','$contents',sysdate())");

  mysql_db_query("b31_c467","UPDATE tweetdes_tbl SET comment=comment+1 WHERE tweet_id={$userid}");

  echo "ツイートしました";
  header("Location: http://a1.zeroprm.com/b31_c467/girls_girls_designZatsudan.php");
}


echo"<a href='http://a1.zeroprm.com/b31_c467/girls_girls_designZatsudan.php'>
 戻る</a>";

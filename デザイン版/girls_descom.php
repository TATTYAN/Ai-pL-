...
mysql_query("SET NAMES utf8",$connect);
  ...
  /////変更↓
	$tweet = mysql_db_query("b31_c467", "select * from destweet_tbl");
  /////
...
//この１行で実行
		...
		$tweet = mysql_db_query("b31_c467","select * from destweet_tbl WHERE tweet_id={$_GET['tweet_id']}");

		$nusi = mysql_fetch_assoc($tweet);

	

	//$rs = mysql_db_query("b31_c467","select * from destweet_tbl order by tseet_time desc");

    /////変更
 	$usercomments = mysql_db_query("b31_c467","select * from DesComment_tbl where userid = $tweet_id order by datetime desc");
  //////
  ...
  <head>
    ...
    <div class="top"><a href="http://a1.zeroprm.com/b31_c467/examples/girls_login.php">
    	...
    	<div class="user">
          ...
          <!--↓変更-->
          <form action ="descomment_inf.php" method="GET">
        ...
        <?php
        	while(true){
        		...
        		if($userrebue == null){
                  ...
                  /////変更
        				echo"<form action= 'g_descom_del.php' method='GET'>
        ...
        ?>
          <!--↓変更-->
        <a class="btn-primary" id="back" href="http://a1.zeroprm.com/b31_c467/girls_designZatsudan.php">戻る</a>
